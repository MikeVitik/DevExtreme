import {
  Event, JSXComponent, Component, ComponentBindings, Effect, Template, Fragment, OneWay, Ref, ForwardRef,
...
export const viewFunction = ({
  viewRef,
  props: {
    viewComponentTemplate: ViewComponent, gridInstance, gridProps,
  },
}: ViewRefWrapper) => (
